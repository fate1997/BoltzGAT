...
class GATv2Concat4Mixture(nn.Module):
    def __init__(self, config):
        ...
        self.pred_head = MLP(2*self.hidden_dim + 3, 256, 1, 3, 0.2, nn.ELU())
    ...
    def forward(self, data1, data2):
        ...
        inter_repr = torch.cat([inter_repr, x, 1-x, data1.temps], dim=1)
        delta_visc = self.pred_head(inter_repr)
